...
CannotWriteFileException::CannotWriteFileException(const char* fileNameParam): fileName(fileNameParam)
{
}

CannotWriteFileException::~CannotWriteFileException() throw()
{
}

const char* CannotWriteFileException::what() const throw()
{
  return (fileName + " cannot be written!").c_str();
}
